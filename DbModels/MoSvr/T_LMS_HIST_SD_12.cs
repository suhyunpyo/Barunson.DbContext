...
[Index("ORDER_FLAG", Name = "IDX_LMSHIST_12_ODRFR")]
[Index("PROC_RESULT", Name = "IDX_LMSHIST_12_PROCRST")]
[Index("RESULT_TIME", Name = "IDX_LMSHIST_12_RESULT")]
[Index("SUBJECT", Name = "IDX_LMSHIST_12_SUBJECT")]
[Index("SERVICE_CODE", Name = "IDX_LMSHIST_12_SVCCODE")]
[Index("TR_SECT", Name = "IDX_LMSHIST_12_TRSECT")]
public partial class T_LMS_HIST_SD_12
{
    [Key]
