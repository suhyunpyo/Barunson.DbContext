...
[Index("ORDER_FLAG", Name = "IDX_LMSHIST_10_ODRFR")]
[Index("PROC_RESULT", Name = "IDX_LMSHIST_10_PROCRST")]
[Index("RESULT_TIME", Name = "IDX_LMSHIST_10_RESULT")]
[Index("SUBJECT", Name = "IDX_LMSHIST_10_SUBJECT")]
[Index("SERVICE_CODE", Name = "IDX_LMSHIST_10_SVCCODE")]
[Index("TR_SECT", Name = "IDX_LMSHIST_10_TRSECT")]
public partial class T_LMS_HIST_SD_10
{
    [Key]
