...
[Index("ORDER_FLAG", Name = "IDX_LMSHIST_11_ODRFR")]
[Index("PROC_RESULT", Name = "IDX_LMSHIST_11_PROCRST")]
[Index("RESULT_TIME", Name = "IDX_LMSHIST_11_RESULT")]
[Index("SUBJECT", Name = "IDX_LMSHIST_11_SUBJECT")]
[Index("SERVICE_CODE", Name = "IDX_LMSHIST_11_SVCCODE")]
[Index("TR_SECT", Name = "IDX_LMSHIST_11_TRSECT")]
public partial class T_LMS_HIST_SD_11
{
    [Key]
