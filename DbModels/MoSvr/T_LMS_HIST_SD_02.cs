...
[Index("ORDER_FLAG", Name = "IDX_LMSHIST_02_ODRFR")]
[Index("PROC_RESULT", Name = "IDX_LMSHIST_02_PROCRST")]
[Index("RESULT_TIME", Name = "IDX_LMSHIST_02_RESULT")]
[Index("SUBJECT", Name = "IDX_LMSHIST_02_SUBJECT")]
[Index("SERVICE_CODE", Name = "IDX_LMSHIST_02_SVCCODE")]
[Index("TR_SECT", Name = "IDX_LMSHIST_02_TRSECT")]
public partial class T_LMS_HIST_SD_02
{
    [Key]
