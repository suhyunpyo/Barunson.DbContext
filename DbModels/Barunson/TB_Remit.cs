...
/// 송금_정보
/// </summary>
[Index("Account_ID", Name = "IX_TB_Remit_Account_ID")]
[Index("Complete_DateTime", Name = "IX_TB_Remit_Compleate_DateTime")]
[Index("Invitation_ID", Name = "IX_TB_Remit_Invitation_ID")]
public partial class TB_Remit
{
    ...
    [ForeignKey("Coupon_Order_ID")]
    [InverseProperty("TB_Remit")]
    ...
    [InverseProperty("Remit")]
    public virtual ICollection<TB_Calculate> TB_Calculate { get; } = new List<TB_Calculate>();
}
