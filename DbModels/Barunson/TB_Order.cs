...
[Index("Payment_DateTime", "Payment_Status_Code", Name = "IX_TB_Order_Payment_DateTime")]
...
public partial class TB_Order
{
    ...
    [InverseProperty("Previous_Order")]
    public virtual ICollection<TB_Order> InversePrevious_Order { get; } = new List<TB_Order>();

    [ForeignKey("Previous_Order_ID")]
    [InverseProperty("InversePrevious_Order")]
    public virtual TB_Order? Previous_Order { get; set; }

    [InverseProperty("Order")]
    public virtual TB_Invitation? TB_Invitation { get; set; }

    [InverseProperty("Order")]
    public virtual TB_Order_Coupon_Use? TB_Order_Coupon_Use { get; set; }

    [InverseProperty("Order")]
    public virtual ICollection<TB_Order_Product> TB_Order_Product { get; } = new List<TB_Order_Product>();

    [InverseProperty("Order")]
    public virtual TB_Order_Serial_Coupon_Use? TB_Order_Serial_Coupon_Use { get; set; }

    [InverseProperty("Order")]
    public virtual ICollection<TB_Refund_Info> TB_Refund_Info { get; } = new List<TB_Refund_Info>();
}
