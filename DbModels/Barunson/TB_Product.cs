...
public partial class TB_Product
{
    ...
    [InverseProperty("Product")]
    public virtual ICollection<TB_Product_Category> TB_Product_Category { get; } = new List<TB_Product_Category>();

    [InverseProperty("Product")]
    public virtual ICollection<TB_Product_Icon> TB_Product_Icon { get; } = new List<TB_Product_Icon>();

    [InverseProperty("Product")]
    public virtual ICollection<TB_Product_Image> TB_Product_Image { get; } = new List<TB_Product_Image>();

    [ForeignKey("Template_ID")]
    [InverseProperty("TB_Product")]
