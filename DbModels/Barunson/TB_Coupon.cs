...
public partial class TB_Coupon
{
    ...
    public virtual ICollection<TB_Coupon_Publish> TB_Coupon_Publish { get; } = new List<TB_Coupon_Publish>();

    [InverseProperty("Coupon")]
    public virtual ICollection<TB_Coupon_Publish_TEST> TB_Coupon_Publish_TEST { get; } = new List<TB_Coupon_Publish_TEST>();
}
