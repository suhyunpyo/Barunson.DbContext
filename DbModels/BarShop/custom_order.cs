...
/// 주문관련정보
/// </summary>
[Index("src_send_date", "status_seq", Name = "IDX_corder__send_date_status_seq", AllDescending = true)]
[Index("weddinfo_id", Name = "IDX_corder__weddinfo_id")]
[Index("settle_status", Name = "IDX_custom_order_settle_status")]
[Index("settle_status", "card_seq", Name = "IDX_custom_order_settle_status_card_seq")]
[Index("order_date", Name = "NCI_custom_order_order_date", AllDescending = true)]
...
public partial class custom_order
{
    ...
    [StringLength(10)]
    [Unicode(false)]
    public string? JebonExpectedDate { get; set; }
