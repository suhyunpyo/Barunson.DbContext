...
/// 샘플주문정보
/// </summary>
[Index("REQUEST_DATE", Name = "IDX_CUSTOM_SAMPLE_ORDER_REQUEST_DATE")]
[Index("DELIVERY_DATE", Name = "IX_CUSTOM_SAMPLE_ORDER_Delivery_Date")]
[Index("STATUS_SEQ", Name = "IX_custom_sample_order_status_seq")]
[Index("STATUS_SEQ", "SALES_GUBUN", Name = "IX_custom_sample_order_status_seq_sales_gubun")]
...
public partial class CUSTOM_SAMPLE_ORDER
{
    ...
    public virtual ICollection<CUSTOM_SAMPLE_ORDER_ITEM> CUSTOM_SAMPLE_ORDER_ITEM { get; } = new List<CUSTOM_SAMPLE_ORDER_ITEM>();
}
