...
/// 문자발송관리 마스터
/// </summary>
[Index("RegDate", Name = "IX_SMSSendMaster_RegDate")]
[Index("SendTime", Name = "IX_SMSSendMaster_SendTime")]
public partial class SMSSendMaster
{
    ...
    /// <summary>
    /// 상태: 0.작성중, 50.취소, 90. 테스트발송대기, 99. 테스트 발송완료, 100. 발송대기, 105. 발송중, 110.발송완료,  
    /// </summary>
